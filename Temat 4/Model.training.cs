...
namespace Lab4
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\izaX1\Desktop\Platfomy programistyczne\lab4\lab4\Train\train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"text",outputColumnName:@"text")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.25029308F,L2Regularization=0.9446097F,LabelColumnName=@"sentiment",FeatureColumnName=@"Features"}))      
